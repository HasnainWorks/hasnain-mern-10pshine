  ...
  return (
    <div className="flex items-center gap-3 mb-8">
      ...
      <select
        ...
        className="bg-[#161616] border border-white/[0.07] rounded-xl px-3 py-2.5 text-sm text-white/50 focus:outline-none focus:border-[#CAFF00]/30 transition-colors cursor-pointer"
      >
